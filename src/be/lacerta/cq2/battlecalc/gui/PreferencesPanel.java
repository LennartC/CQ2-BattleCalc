...
public class PreferencesPanel extends MPanel {
  ...
  private PreferencesPanel opponentsPanel = null;
  private String[] curses = {"           ", "Suffocation", "Metamorphosis"};

  static Hashtable<String, Creature> critMap = null;

  public PreferencesPanel(URL imageURL, Color bgcolor) {
    ...
    add("gridx=0,gridy=5,fill=HORIZONTAL,weightx=1.0,insets=[1,0,0,0]",new JLabel("Item: "));
    itemBox = new JComboBox(Item.ITEMS);
    add("gridx=1,gridy=5,gridwidth=2,fill=HORIZONTAL,weightx=1.0,insets=[1,0,0,0]",itemBox);
    enchantBox = new JComboBox(Item.ENCHANTS);
    add("gridx=3,gridy=5,fill=HORIZONTAL,weightx=1.0,insets=[1,0,0,0]",enchantBox);
  ...
  public void setOpponentsPanel(PreferencesPanel panel) {
